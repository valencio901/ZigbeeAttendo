...
// Sort the attendance data by the 'attendance_percentage' in descending order
usort($attendanceData, function($a, $b) {
    return $b['attendance_percentage'] - $a['attendance_percentage'];
});

// Display the top 3 databases with the highest attendance
echo "<h2>Top 3 Databases with the Highest Attendance:</h2>";
